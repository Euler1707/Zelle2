...
class Player:
    # A Plater keeps track of service probability and score
    ...
    def getScore(self):
        # RETURNS this playe's current score
        return self.score

class RBallGame:
    # RBallGame represents a game in progress. A game has two players
    # and keeps track of which on is currently serving
    
    def __init__(self, probA, probB):
        # Create a new game having players with the give probs.
    ...
    def isOver(self):
        # RETURN game is finished ( i.e someone has won)
        a,b = self.getScores()
    ...
    def getScores(self):
        # RETURNS the current scores of a player A and player B
